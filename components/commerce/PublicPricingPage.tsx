      ...
      <div className="container pb-14">
        ...
        <section className="mt-8 shell-panel border-plum-400/30 bg-gradient-to-br from-plum-500/8 to-stone-950 p-6 md:p-7">
          <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div>
              <p className="shell-kicker text-plum-200">Start with a conversation</p>
              <h2 className="shell-section-title mt-3">
                Stelloquy Sampler — $1
              </h2>
              <p className="mt-4 text-sm leading-7 text-bone-muted">
                Three messages with your natal chart and the current sky — no planner required. One sampler per account.
              </p>
            ...
            <div className="rounded-xl border border-plum-400/40 bg-stone-900/60 px-5 py-4">
              ...
              <p className="mt-3 text-sm leading-6 text-bone-muted">
                Natal chart (ten placements) · Current sky (transits, Moon, retrogrades) · Three Stelloquy messages
              </p>
            </div>
          </div>
        </section>
