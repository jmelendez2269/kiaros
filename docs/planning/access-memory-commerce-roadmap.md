...
- **Full implementation:** 10 of 31 implementation rows are `done` — **32% complete**.
...
- **Whole tracker, including founder decisions:** 17 of 38 rows are `done` — **45%**; 20 of 38 are `done` or `verification` — **53%**.
