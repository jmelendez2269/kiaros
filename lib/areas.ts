...
const AREA_DEFINITIONS: AreaDefinition[] = [
  ...
  },
  {
    ...
    summary: 'The body, daily rhythms, nervous-system regulation, and the small practices that keep you well.',
    plannerPrompt: 'Track when the chart supports building routine, repairing tissue, deepening rest, or recalibrating habits.',
    primaryHouses: [6, 1, 12],
    secondaryHouses: [2, 8],
    supportStrategies: [
      'Use steady windows for routine-building — movement, sleep, nourishment cadence.',
      'Use lower-energy windows for restorative work — rest, recovery, nervous-system care.',
      'Use reflective windows to notice what your body has been carrying and what it is asking for.',
    ],
    energyMode: 'stabilizing',
    yearThemeTemplate: 'Wellbeing deepens through consistent rhythm, honest rest, and a kinder relationship with the body.',
    interpretationLead: 'This year invites your health to feel less like a project to fix and more like a daily conversation with the body.',
  },
  {
    slug: 'creative-projects',
    name: 'Creative Projects',
    summary: 'Original work, play, voice, and the practice of making something that did not exist before.',
    plannerPrompt: 'Track when the sky supports drafting, refining, releasing, or letting the work rest.',
    primaryHouses: [5, 3, 11],
    secondaryHouses: [9, 10],
    supportStrategies: [
      'Use generative windows for first drafts, sketches, and the playful experiments that do not need to be good yet.',
      'Use craft windows for editing, structure, and the slower work of refining what already exists.',
      'Use connective windows to share the work and find the people it is for.',
    ],
    energyMode: 'opening',
    yearThemeTemplate: 'Creative momentum compounds through play, repetition, and the courage to let the work be seen.',
    interpretationLead: 'This year asks your creative life to move from private practice into something with shape, voice, and an audience.',
  },
  {
    slug: 'personal-growth',
    name: 'Personal Growth',
    summary: 'Inner work, integration, learning, and the slow remodelling of how you move through your life.',
    plannerPrompt: 'Track when the chart supports inner inquiry, study, integration, and the recalibration of identity.',
    primaryHouses: [9, 12, 1],
    secondaryHouses: [4, 8],
    supportStrategies: [
      'Use expansive windows for study, travel, or the input that widens your sense of what is possible.',
      'Use quieter windows for therapy, journalling, dreams, and the work that lives below the surface.',
      'Use threshold windows to notice what you have outgrown and what wants to become true next.',
    ],
    energyMode: 'recalibrating',
    yearThemeTemplate: 'Identity refines through study, inner work, and the steady integration of what you have already learned.',
    interpretationLead: 'This year wants your inner life to feel less like a self-improvement campaign and more like a deepening relationship with yourself.',
  },
  {
    slug: 'family',
    name: 'Family',
    summary: 'Lineage, home, the people you came from, and the people you are choosing to root with now.',
    plannerPrompt: 'Track when the chart supports tending the home base, honouring lineage, or renegotiating family patterns.',
    primaryHouses: [4, 5, 3],
    secondaryHouses: [10, 7],
    supportStrategies: [
      'Use grounding windows for time at home, repair work, and being present with the people closest to you.',
      'Use ancestral windows to look at what you inherited and decide what to carry forward.',
      'Use honest windows for conversations that have been waiting in the background.',
    ],
    energyMode: 'stabilizing',
    yearThemeTemplate: 'Family life steadies through honest presence, named patterns, and tending the foundations underneath everything else.',
    interpretationLead: 'This year invites your family relationships to become more conscious, less reactive, and more aligned with who you are now.',
  },
  {
    slug: 'spirituality',
    name: 'Spirituality',
    summary: 'Practice, mystery, the felt sense of something larger, and the disciplines that keep you in contact with it.',
    plannerPrompt: 'Track when the sky supports practice, retreat, inner listening, and trusting what is not yet visible.',
    primaryHouses: [12, 9, 8],
    secondaryHouses: [4, 5],
    supportStrategies: [
      'Use quiet windows for ritual, prayer, meditation, or whatever your form of practice is.',
      'Use threshold windows for retreat, fasting, or the deliberate stripping back of noise.',
      'Use integration windows to translate inner experience into how you actually live.',
    ],
    energyMode: 'opening',
    yearThemeTemplate: 'Practice deepens through quiet repetition, honest devotion, and listening for what is already underway.',
    interpretationLead: 'This year asks your spiritual life to feel less like a belief system and more like a daily practice that shapes how you meet everything else.',
  },
]

const PLANET_LABELS: Record<'sun' | 'moon' | 'mercury' | 'venus' | 'mars' | 'jupiter' | 'saturn' | 'uranus' | 'neptune' | 'pluto', Planet> = {
  sun: 'Sun',
  moon: 'Moon',
  mercury: 'Mercury',
  venus: 'Venus',
